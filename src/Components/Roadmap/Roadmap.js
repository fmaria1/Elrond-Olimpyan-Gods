          ...
          <div className="roadmap-container">
            <VerticalTimeline>
              ...
              <VerticalTimelineElement
                ...
                icon={<CheckIcon />}
              >
                <h4 className="roadmap-element-title">
                  {this.props.data.q1_2}
                </h4>
              </VerticalTimelineElement>
              <VerticalTimelineElement
                className="roadmap-element"
